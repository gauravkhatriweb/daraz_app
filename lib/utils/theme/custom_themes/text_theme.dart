...
class DTextTheme {
  ...
  static TextTheme lightTextTheme = TextTheme(
    ...
    titleSmall: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w500, color: Colors.black),
    ...
    bodySmall: TextStyle(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.black.withAlpha(128)),
    labelLarge: TextStyle(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.black),
    labelMedium: TextStyle(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.black.withAlpha(128)),
  );
  ...
  static TextTheme darkTextTheme = TextTheme(
    ...
    titleSmall: TextStyle(fontSize: 16.0, fontWeight: FontWeight.w500, color: Colors.white),
    ...
    bodySmall: TextStyle(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.white.withAlpha(128)),
    labelLarge: TextStyle(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.white),
    labelMedium: TextStyle(fontSize: 12.0, fontWeight: FontWeight.normal, color: Colors.white.withAlpha(128)),
  );
}
